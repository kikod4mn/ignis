...
Encore
	 ...
	 */
	.addEntry('kikopolis', './assets/app.js')
	.addEntry('register-validations', './assets/js/register-form-validations.js')
	.addEntry('password-change-validations', './assets/js/password-change-form-validations.js')
